...
public class Number2 {
	...
	public static void main(String[] args) {
		...
		System.out.println(
				"Select and write 5 Countries from this list: Ethiopia, Egypt, Kenya, Germany, Turkiye, Moldova, Ukraine");

		String[] countriessEntered = new String[5];

		for (int i = 0; i < 5; i++) {
			System.out.println("Enter " + (i + 1) + ". country: ");
